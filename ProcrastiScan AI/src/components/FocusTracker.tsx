...
const playBeep = (type: "start" | "tick" | "success" | "warning") => {
  try {
    ...
    if (type === "start") {
      ...
      osc.type = "sine";
      osc.frequency.setValueAtTime(830.61, ctx.currentTime); // G#5 elegant alert note
      osc.frequency.setValueAtTime(622.25, ctx.currentTime + 0.12); // D#5 elegant alert minor fall note
      gain.gain.setValueAtTime(0.08, ctx.currentTime);
