...
export default function DiagnosticQuiz({ userName, onNavigateToAudio, onNavigateToTriggers }: DiagnosticQuizProps) {
  ...
  const currentQuestionData = QUIZ_QUESTIONS[currentStep - 1];
